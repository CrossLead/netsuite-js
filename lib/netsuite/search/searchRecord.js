...
/**
 * Do not auto serialize `searchField`. @see geXml
 * @override
 */
...
SearchRecord.prototype.getXml = function() {
  var xml = '';
  if (this.searchField) {
    xml = '<platformCommon:' + this.searchField.field + ' operator="' + this.searchField.operator + '" xsi:type="platformCore:SearchStringField"><platformCore:searchValue>' + this.searchField.searchValue + '</platformCore:searchValue></platformCommon:' + this.searchField.field + '>';
  }
