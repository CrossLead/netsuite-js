 ...
 */
var Configuration = module.exports = function Configuration(credentials, options, netsuiteType) {
	...
	// Default
	if(netsuiteType == 'sandbox') {
		console.log('Sandbox Netsuite URL...');
		this._webservicesDomain = 'https://webservices.sandbox.netsuite.com';
		this._restURL = 'rest.sandbox.netsuite.com';
	} else {
		console.log('Production Netsuite URL...');
		this._webservicesDomain = 'https://webservices.netsuite.com/';
		this._restURL = 'rest.netsuite.com';
	}
};
